...
ALTER TABLE game_storytellers
    ADD CONSTRAINT FK_GAME_STORYTELLERS_ON_GAME FOREIGN KEY (game_id) REFERENCES games (id) ON DELETE CASCADE;

ALTER TABLE game_storytellers
    ADD CONSTRAINT FK_GAME_STORYTELLERS_ON_PLAYER FOREIGN KEY (player_id) REFERENCES players (id) ON DELETE SET NULL;
...
ALTER TABLE player_participations
    ADD CONSTRAINT FK_PLAYER_PARTICIPATIONS_ON_GAME FOREIGN KEY (game_id) REFERENCES games (id) ON DELETE CASCADE;
...
ALTER TABLE game_winning_players
    ADD CONSTRAINT GMbZz2 FOREIGN KEY (game_id) REFERENCES games (id) ON DELETE CASCADE;

ALTER TABLE script_characters
    ADD CONSTRAINT X9brKa FOREIGN KEY (character_id) REFERENCES characters (id) ON DELETE CASCADE;

ALTER TABLE game_winning_players
    ADD CONSTRAINT dUMLCI FOREIGN KEY (player_id) REFERENCES players (id) ON DELETE CASCADE;

ALTER TABLE script_characters
    ADD CONSTRAINT twcjxL FOREIGN KEY (script_id) REFERENCES scripts (id) ON DELETE CASCADE;
